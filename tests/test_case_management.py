...
class TestCaseManagement:
    def test_all_code_paths(self):
        ...
        tests = {
            ...
            "entities_notification_groups_post_v2": falcon.create_notification_group_v2(name="whatever",
                                                                                        description="whatever",
                                                                                        channels={"config_id": "123", "type": "email", "params": {}}
                                                                                        ),
            "entities_notification_groups_patch_v2": falcon.update_notification_group_v2(id="1234567",
                                                                                         name="whatever",
                                                                                         description="whatever",
                                                                                         channels=[{"config_id": "123", "type": "email", "params": {}}]
                                                                                         ),
