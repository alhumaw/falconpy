...
class CloudSecurityCompliance(ServiceClass):
    ...
    def cloud_compliance_framework_posture_summaries(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        ...
        Keyword arguments:
        ids -- The uuids of compliance frameworks to retrieve (maximum 20 IDs allowed).
        ...
        Swagger URL
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/cloud-security-compliance/cloud-compliance-framework-posture-summaries
        """
    ...
    def cloud_compliance_rule_posture_summaries(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        ...
        Swagger URL
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/cloud-security-compliance/cloud-compliance-rule-posture-summaries
