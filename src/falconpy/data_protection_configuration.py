...
class DataProtectionConfiguration(ServiceClass):
    ...
    def get_classification(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        ...
        Swagger URL
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/data-protection-configuration/entities.classification.get.v2
        """
    ...
    @force_default(defaults=["parameters"], default_types=["dict"])
    def delete_classification(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        ...
        Swagger URL
        https://assets.falcon.crowdstrike.com/support/api/swagger.html#/data-protection-configuration/entities.classification.delete.v2
        """
        return process_service_request(
            calling_object=self,
            endpoints=Endpoints,
    ...
    @force_default(defaults=["parameters"], default_types=["dict"])
    def get_cloud_application(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        """Get a particular cloud-application.

        Keyword arguments:
        ids -- The cloud application id(s) to get.
        parameters -- Full parameters payload dictionary. Not required if using other keywords.
    ...
    def delete_cloud_application(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        ...
        Keyword arguments:
        ids -- The id of the cloud application to delete.
        parameters -- Full parameters payload dictionary. Not required if using other keywords.
    ...
    @force_default(defaults=["parameters"], default_types=["dict"])
    def get_content_pattern(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        """Get a particular content-pattern(s).

        Keyword arguments:
        ids -- The content-pattern id(s) to get.
        parameters -- Full parameters payload dictionary. Not required if using other keywords.
    ...
    @force_default(defaults=["parameters"], default_types=["dict"])
    def delete_content_pattern(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        """Delete content pattern.

        Keyword arguments:
        ids -- The id(s) of the content pattern to delete.
        parameters -- Full parameters payload dictionary. Not required if using other keywords.
    ...
    @force_default(defaults=["parameters"], default_types=["dict"])
    def get_enterprise_account(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        """Get a particular enterprise-account(s).

        Keyword arguments:
        ids -- The enterprise-account id(s) to get.
        parameters -- Full parameters payload dictionary. Not required if using other keywords.
    ...
    def delete_enterprise_account(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        ...
        Keyword arguments:
        ids -- The id of the enterprise account to delete.
        parameters -- Full parameters payload dictionary. Not required if using other keywords.
    ...
    @force_default(defaults=["parameters"], default_types=["dict"])
    def get_file_type(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        """Get a particular file-type.

        Keyword arguments:
        ids -- The file-type id(s) to get.
        parameters -- Full parameters payload dictionary. Not required if using other keywords.
    ...
    @force_default(defaults=["parameters"], default_types=["dict"])
    def get_sensitivity_label(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
    ...
    def delete_sensitivity_label(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        ...
        Keyword arguments:
        ids -- The sensitivity label entity id(s) to delete.
        parameters -- Full parameters payload dictionary. Not required if using other keywords.
    ...
    @force_default(defaults=["parameters"], default_types=["dict"])
    def get_web_location(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        """Get web-location entities matching the provided ID(s).

        Keyword arguments:
        ids -- The web-location entity id(s) to get.
        parameters -- Full parameters payload dictionary. Not required if using other keywords.
    ...
    def update_web_location(self: object, body: dict = None, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        ...
        Keyword arguments:
        id -- The web-location entity id to update.
        body -- Full body payload provided as a dictionary. Not required if using other keywords.
        {
            "web_locations": [
                {
    ...
    @force_default(defaults=["parameters"], default_types=["dict"])
    def delete_web_location(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        """Delete web-location.

        Keyword arguments:
        ids -- The ids of the web-location to delete.
        parameters -- Full parameters payload dictionary. Not required if using other keywords.
    ...
    def query_file_type(self: object, parameters: dict = None, **kwargs) -> Union[Dict[str, Union[int, dict]], Result]:
        ...
        Keyword arguments:
        filter -- The filter to use when finding file types. Allowed filters are 
                  name          created_at
                  updated_at
        sort -- The sort instructions to order by on. Allowed values are
                  name          created_at
